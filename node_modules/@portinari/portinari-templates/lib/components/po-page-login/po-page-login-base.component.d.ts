...
export declare abstract class PoPageLoginBaseComponent implements OnDestroy {
     ...
     *
     */
    customField: string | PoPageLoginCustomField;
    /**
     ...
     */
    recovery: string | Function | PoPageLoginRecovery;
    /**
     * @optional
     *
     * @description
     ...
     */
    authenticationType: PoPageLoginAuthenticationType;
    /**
     * @optional
     *
     * @description
    ...
    readonly pageLoginLiterals: PoPageLoginLiterals;
