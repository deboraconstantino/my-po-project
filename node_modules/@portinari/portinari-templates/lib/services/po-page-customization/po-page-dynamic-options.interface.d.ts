 ...
 */
export interface PoPageDynamicOptions {
    /**
...
export declare type PoCustomizationFunction = () => PoPageDynamicOptions;
export declare type UrlOrPoCustomizationFunction = string | PoCustomizationFunction;
