...
export declare class PoUploadComponent extends PoUploadBaseComponent implements AfterViewInit {
    ...
    progressStatusByFileStatus: {
        [PoUploadStatus.Uploaded]: PoProgressStatus;
        [PoUploadStatus.Error]: PoProgressStatus;
    };
    ...
    readonly displayDragDrop: boolean;
    readonly displaySendButton: boolean;
    readonly selectFileButtonLabel: string;
    readonly hasMoreThanFourItems: boolean;
